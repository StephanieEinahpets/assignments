...
// and a property name as input. The function should return a new array 
...
// Write a function called createTable(rows, columns) that takes 
// two parameters: rows (number of rows) and columns (number of 
// columns). The function should generate a table represented as an 
// array of arrays, where each inner array represents a row and contains 
// the row's data. Each cell in the table should contain the product of 
